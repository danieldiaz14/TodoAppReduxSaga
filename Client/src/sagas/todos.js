...
import { call, takeEvery, fork, takeLatest, put, take } from 'redux-saga/effects';
//workerSaga
function* getTodos() {
    try {
...
function* updateTodo(action) {
    try {
        yield call(test, {title: action.payload.title, description: action.payload.description, id: action.payload.id});
        yield call(getTodos);
    } catch(e) {
        console.log(e)
    }
